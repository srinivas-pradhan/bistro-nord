        ...
        <div className="flex justify-between h-28 pl-6 lg:pl-10 pt-8 w-full text-black bg-white">
            ...
            >
                <ul className="flex flex-row gap-4">
                    ...
                    <li className="flex items-center font-playfair-display-semibold-italic text-3xl">Bistro Nord</li>
                </ul>
            </div>
            <div className="hidden lg:flex text-xl pt-4">
            ...
            >
                <div className="pt-1.5 pr-10">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px" fill="#b91c1c">
